                ...
                <div class="col-lg-10 col-lg-offset-1">
                    <article class="hentry post post-standard-details">
                        ...
                        <div class="post-thumb">
                            <img src="storage/{{ $post->featured }}" alt="seo">
                        </div>
                    ...
                    <div class="pagination-arrow">
                        ...
                        @if($prev)
                            <a href="{{ route('post.show',['slug' => $prev->slug ]) }}" class="btn-next-wrap">
                        ...
                        @if($next)
                        <a href="{{ route('post.show',['slug' => $next->slug ]) }}" class="btn-prev-wrap">
                            <svg class="btn-prev">
                                <use xlink:href=""></use>
                            </svg>
                            <div class="btn-content">
